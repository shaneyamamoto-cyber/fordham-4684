...
(function (root) {
  ...
  const FURN = [
    [22.9,0.3, 41.5,2.4, 3.0,0,"counter"],
    [23.0,0.3, 25.2,2.4, 4.5,0,"upper cab"],
    [25.5,0.5, 28.9,2.2, 3.0,0,"sink"],
    [29.1,0.3, 32.3,2.4, 4.5,0,"upper cab"],
    [41.5,0.3, 43.8,10.2,3.0,0,"counter"],
    [41.5,0.4, 43.8,2.6, 6.0,0,"fridge"],
    [41.5,2.9, 43.8,5.4, 6.0,0,"ovens"],
    [41.7,7.7, 43.6,9.6, 3.0,0,"sink"],
    [23.3,5.4, 28.2,9.2, 3.0,0,"pantry / appl garage"],
    [32.4,6.6, 33.6,9.4, 4.5,0,"upper cab"],
    [33.0,4.5, 39.0,10.0,3.0,1,"kitchen island"],
    [34.3,18.2,40.4,21.2,2.5,0,"dining table"],
    [20.7,8.8, 22.3,13.9,3.5,0,"f.p."],
    [20.7,5.3, 22.3,8.8, 7.0,0,"built-in"],
    [20.7,13.9,22.3,20.0,7.0,0,"built-in"],
    ...
    [47.8,11.6,49.9,13.6,3.0,0,"sink"],
    [50.1,11.6,52.2,13.6,3.0,0,"washer"],
    [52.4,11.6,54.5,13.6,3.0,0,"dryer"],
