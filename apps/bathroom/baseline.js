...
(function () {
  ...
  window.BATHROOM_BASELINE = {
    height: 92, kneeH: 0, slopeRun: 32, trimTone: 'rose', drawersLeft: 2, drawersRight: 3, bankW: 10.9, bankGap: 1.5,
    ...
    items: [
      ...
      {id:'tap',name:'Wall spout',x:76,w:8,y:42.5,h:2,dep:8,face:0,shape:'soft',tone:'#b76e79'},
      {id:'taphl',name:'Mixer lever',x:88,w:3.5,y:42.5,h:2,dep:3,face:0,shape:'soft',tone:'#b76e79'},
      ...
      {id:'rain',name:'Rainhead',x:11,w:10,y:80,h:4,dep:12,face:14.5,tone:'#b76e79'},
      {id:'mixer',name:'Mixer / diverter',x:13,w:6,y:41.38,h:6,dep:3,face:14.5,shape:'round',tone:'#b76e79'},
      {id:'spout',name:'Tub spout',x:13,w:6,y:26,h:3,dep:6,face:14.5,tone:'#b76e79'},
      {id:'bar2',name:'Towel bar — tub upper',x:38.33,w:18,y:27.5,h:2,dep:4,face:14.5,wall:'slope',d:14,tone:'#b76e79'},
      {id:'bar3',name:'Towel bar — tub lower',x:36.72,w:18,y:22.5,h:2,dep:4,face:14.5,wall:'slope',d:14,tone:'#b76e79'},
      {id:'ring',name:'Hand towel ring',x:62.5,w:7,y:40.63,h:7.25,dep:4,face:0,tone:'#b76e79'}
    ]
  };
})();
