...
(function () {
  ...
  window.BATHROOM_BASELINE = {
    height: 92, kneeH: 0, slopeRun: 32, trimTone: 'copper', drawersLeft: 2, drawersRight: 3, bankW: 10.9, bankGap: 1.5,
    ...
    items: [
      ...
      {id:'tap',name:'Wall spout',x:76,w:8,y:44,h:2,dep:8,face:0,shape:'soft',tone:'#c9a35c'},
      {id:'taphl',name:'Mixer lever',x:88,w:3.5,y:41,h:2,dep:3,face:0,shape:'soft',tone:'#c9a35c'},
      {id:'light',name:'Sconce — left',x:59.5,w:2.5,y:48,h:19,dep:3.5,face:0,shape:'soft',tone:'#c9a35c'},
      {id:'light2',name:'Sconce — right',x:109,w:2.5,y:48,h:19,dep:3.5,face:0,shape:'soft',tone:'#c9a35c'},
